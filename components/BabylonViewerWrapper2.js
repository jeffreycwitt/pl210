...
import { FreeCamera, Vector3, Vector4, HemisphericLight, MeshBuilder, ArcRotateCamera, Mesh} from "@babylonjs/core";
...
const createScene = (scene) => {
  ...
  {
    diameter: 50, 
    sideOrientation: Mesh.DOUBLESIDE, frontUVs: f, backUVs: b
  }
  );
...
export default function BabylonViewerWrapper2(){
  return (
  <div>
